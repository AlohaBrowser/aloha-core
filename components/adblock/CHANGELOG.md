# Release Notes
## eyeo Browser Ad Filtering Solution 150.0
* Updated to Chromium 150.0.7871.3
* Updated snippet lib to version 2.12.0
* Removed i_dont_care_about_cookies.txt from subscription config

## eyeo Browser Ad Filtering Solution 149.0
* Updated to Chromium 149.0.7827.5

## eyeo Browser Ad Filtering Solution 148.0
* Updated to Chromium 148.0.7778.3
* Updated snippet lib to version 2.8.0

## eyeo Browser Ad Filtering Solution 147.0
* Updated to Chromium 147.0.7727.2

## eyeo Browser Ad Filtering Solution 146.0
* Updated to Chromium 146.0.7680.3
* Fixed unnecessary element hiding injection on main frame about:blank pages
* Updated snippet lib to version 2.5.0

## eyeo Browser Ad Filtering Solution 145.0
* Updated to Chromium 145.0.7632.7

## eyeo Browser Ad Filtering Solution 144.0
* Updated to Chromium 144.0.7559.3
* Updated snippet lib to version 2.4.5 (DPD-3537)

## eyeo Browser Ad Filtering Solution 143.0
* Updated to Chromium 143.0.7499.3
* Fixed crash on dynamic snippet update (DPD-3488)
* Fixed upstream browser tests (DPD-3491)
* Updated snippet lib to version 2.4.2 (DPD-3505)

## eyeo Browser Ad Filtering Solution 142.0
* Updated to Chromium 142.0.7444.3
* Introduced AI drived chromium version updates (DPD-3454)
* Fixed UT for Windows platform (DPD-3478)

## eyeo Browser Ad Filtering Solution 141.0
* Updated to Chromium 141.0.7390.5

## eyeo Browser Ad Filtering Solution 140.0
* Updated to Chromium 140.0.7339.4
* Added dynamic snippet update (DPD-3255 & DPD-3428)
* Updated snippet library to version 2.3.0
* Added support for parametrized FL urls (DPD-3420)

## eyeo Browser Ad Filtering Solution 139.0
* Updated to Chromium 139.0.7258.3

## eyeo Browser Ad Filtering Solution 138.0
* Updated to Chromium 138.0.7204.45
* Fixed EH & EHE notification in incognito (DPD-3382)
* Various stability fixes (DPD-3334, DPD-3307)


## eyeo Browser Ad Filtering Solution 137.0
* Updated to Chromium 137.0.7151.44
* Fixed linking error on Windows when is_component_build=true (DPD-3352)
* Added notifications for page elements hidden by EH and EHE filters (DPD-1744)

## eyeo Browser Ad Filtering Solution 136.0
* Updated to Chromium 136.0.7103.44

## eyeo Browser Ad Filtering Solution 135.0
* Updated to Chromium 135.0.7049.38
* Updates and cleanup for elemhideemu.jst (DPD-3216)
* Removed adblock-internals page in incognito mode (DPD-3237)
* Wired Eyeo domain handler in CDT protocol (DPD-3129)
* Removed redundant annotations in eyeoFilteringPrivate (DPD-3265)
* Added code to clear old kTelemetryAcceptableAdsStats pref (DPD-3145)
* Fixed counters in InProgessRequest for case of non-frame initiator

## eyeo Browser Ad Filtering Solution 134.0
* Updated to Chromium 134.0.6998.4
* Updated snippet library to version 2.0.0 (DPD-3211)

## eyeo Browser Ad Filtering Solution 133.0
* Updated to Chromium 133.0.6943.13
