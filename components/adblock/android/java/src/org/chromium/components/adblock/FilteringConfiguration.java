...
public final class FilteringConfiguration {
    ...
    private static int mDownloadDelaySec = 10; // ALOHA https://app.clickup.com/t/86er9wwca
    ...
    private FilteringConfiguration(
        ...
        mNativeController =
                FilteringConfigurationJni.get()
                        .create(this, configuration_name, browserContextHandle, mDownloadDelaySec); // ALOHA https://app.clickup.com/t/86er9wwca
    }
    ...
    @UiThread // ALOHA https://app.clickup.com/t/86er9wwca
    public static void setFiltersDownloadDelay(int delay) {
        mDownloadDelaySec = delay;
    }
    ...
    interface Natives {
        ...
        long create(
                ...
                int downloadDelaySec); // ALOHA https://app.clickup.com/t/86er9wwca
