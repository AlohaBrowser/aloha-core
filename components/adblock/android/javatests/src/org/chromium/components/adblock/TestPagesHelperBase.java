...
public abstract class TestPagesHelperBase
    ...
    // Note: Use either setOnAdMatchedLatch XOR setOnAdMatchedExpectations XOR
    // setOnPageElementMatchedExpectations
    ...
    // Note: Use either setOnAdMatchedLatch XOR setOnAdMatchedExpectations XOR
    // setOnPageElementMatchedExpectations
    // Note: It is expected to provide a singe Set argument keeping others null
    public CountDownLatch setOnPageElementMatchedExpectations(
            final Set<String> onHidden,
            final Set<String> onRemoved,
            final Set<String> onInlineCss) {
        Assert.assertTrue(
                mObserver.countDownLatch == null || mObserver.countDownLatch.getCount() == 0);
        mObserver.countDownLatch = new CountDownLatch(1);
        mObserver.expectedHidden = onHidden;
        mObserver.expectedRemoved = onRemoved;
        mObserver.expectedInlineCss = onInlineCss;
        return mObserver.countDownLatch;
    }
