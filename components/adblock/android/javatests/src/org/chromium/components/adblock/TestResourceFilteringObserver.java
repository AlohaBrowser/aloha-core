...
public class TestResourceFilteringObserver
    ...
    public void onPageElementMatched(ResourceFilteringCounters.PageElementInfo info) {
        if (countDownLatch != null) {
            if (expectedHidden == null && expectedRemoved == null && expectedInlineCss == null) {
            ...
            switch (info.getAction()) {
                case HIDE:
                    targetSet = expectedHidden;
                    break;
                case REMOVE:
                    targetSet = expectedRemoved;
                    break;
                case INLINE_CSS:
                    targetSet = expectedInlineCss;
                    break;
                default:
            }
            if (targetSet != null) {
                targetSet.remove(info.getSelector());
    ...
    Set<String> expectedHidden;
    Set<String> expectedRemoved;
    Set<String> expectedInlineCss;
}
