...
public abstract class TestPagesSnippetsTestBase {
    ...
    public void testArrayOverride() throws Exception {
        mHelper.loadUrlWaitForContent(
                TestPagesHelperBase.SNIPPETS_TESTPAGES_TESTCASES_ROOT + "array-override");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#array-override-push-area > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#array-override-includes-area > div[data-expectedresult='fail']");
    }

    @Test
    @LargeTest
    @Feature({"adblock"})
    public void testHideIfCanvasContains() throws Exception {
        mHelper.loadUrlWaitForContent(
                TestPagesHelperBase.SNIPPETS_TESTPAGES_TESTCASES_ROOT + "hide-if-canvas-contains");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#filltext-area > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 1, "div#filltext-area > div[data-expectedresult='pass']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#stroketext-area > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 1, "div#stroketext-area > div[data-expectedresult='pass']");
    }

    @Test
    @LargeTest
    @Feature({"adblock"})
    public void testHideIfContainsSimilarText() throws Exception {
        mHelper.loadUrlWaitForContent(
                TestPagesHelperBase.SNIPPETS_TESTPAGES_TESTCASES_ROOT
                        + "hide-if-contains-similar-text");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#basic-usage-area > p[data-expectedresult='fail']");
    }

    @Test
    @LargeTest
    @Feature({"adblock"})
    public void testReplaceFetchResponse() throws Exception {
        mHelper.loadUrlWaitForContent(
                TestPagesHelperBase.SNIPPETS_TESTPAGES_TESTCASES_ROOT + "replace-fetch-response");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#test-basic-usage > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#test-string-replacement > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper,
                0,
                "div#test-string-replacement-with-needle> div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#test-regex-parameters > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper,
                0,
                "div#test-multiple-string-replacement > div[data-expectedresult='fail']");
    }

    @Test
    @LargeTest
    @Feature({"adblock"})
    public void testReplaceXhrResponse() throws Exception {
        mHelper.loadUrlWaitForContent(
                TestPagesHelperBase.SNIPPETS_TESTPAGES_TESTCASES_ROOT + "replace-xhr-response");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#test-basic-usage > div[data-expectedresult='fail']");
        TestVerificationUtils.verifyDisplayedCount(
                mHelper, 0, "div#test-string-replacement > div[data-expectedresult='fail']");
