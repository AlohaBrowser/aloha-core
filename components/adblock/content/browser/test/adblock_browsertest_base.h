...
class TestResourceClassificationRunnerObserver
 ...
 public:
  ...
  std::vector<GURL> allowed_ads_notifications_;
  std::vector<GURL> blocked_popups_notifications_;
  std::vector<GURL> allowed_popups_notifications_;
  std::vector<GURL> allowed_pages_notifications_;
  std::vector<std::string> hidden_notifications_;
  std::vector<std::string> removed_notifications_;
  std::vector<std::string> inline_css_notifications_;
};
...
class AdblockBrowserTestBase : public content::ContentBrowserTest {
 public:
  ...
  const std::string& GetTelemetryDomain();
