...
TEST_F(AdblockResourceClassificationRunnerImplTest,
  ...
  classification_runner_->CheckRequestFilterMatch(std::move(*mock_snapshot_),
                                                  kUrl, ContentType::Image,
                                                  *main_rfh(), callback.Get());
...
TEST_F(AdblockResourceClassificationRunnerImplTest,
  ...
  classification_runner_->CheckDocumentAllowlisted(std::move(*mock_snapshot_),
                                                   kUrl, *main_rfh());
...
TEST_F(AdblockResourceClassificationRunnerImplTest,
  ...
  classification_runner_->CheckResponseFilterMatch(
      std::move(*mock_snapshot_), kUrl, ContentType::Image, *main_rfh(),
