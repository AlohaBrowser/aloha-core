...
class AdblockTrustedEventsTest
 ...
 public:
  ...
  // ERROR:render_process_host_impl.cc(5532)] Terminating render process for
  // bad Mojo message: Received bad user message: No binder found for interface
  // adblock.mojom.ElementHideApi for the frame/document scope
