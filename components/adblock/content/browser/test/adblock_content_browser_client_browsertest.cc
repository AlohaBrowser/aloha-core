...
namespace {
base::FilePath GetChromeTestDataWebsocketDir() {
  return base::FilePath(FILE_PATH_LITERAL("chrome/test/data/websocket"));
}
}  // namespace
...
class AdblockContentBrowserClientBrowserTest : public AdblockBrowserTestBase {
 public:
  AdblockContentBrowserClientBrowserTest()
    ...
    ws_server_.AddDefaultHandlers(GetChromeTestDataWebsocketDir());
  }
