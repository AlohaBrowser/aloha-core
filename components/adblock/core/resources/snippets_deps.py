...
class SnippetsUtils:
    ...
    # Fix ML service communication with main snippet script
    def prepare_script(self):
        with open(self.script_input_file, 'r', encoding='utf8') as f_source:
            content = f_source.read()
        content = content.replace(
            'chrome.runtime.sendMessage(',
            'chrome.runtime.sendMessage("phhdcbipnceblbigdhhoahagpfdblied", ')
        with open(self.script_output_file, 'w', encoding='utf8') as f_dest:
