...
public class AdblockAwSettingsTest {
    ...
    public void setUp() {
        ...
        mHelper.addFilterList(TestPagesHelper.TESTPAGES_SUBSCRIPTION);
    }
    ...
    public void testSuppressUrlFilters() throws Exception {
        ...
        mHelper.loadUrl(TestPagesHelper.FILTER_TESTPAGES_TESTCASES_ROOT + "image");
        ...
        mHelper.loadUrl(TestPagesHelper.FILTER_TESTPAGES_TESTCASES_ROOT + "blocking");
    ...
    public void testSuppressCssFilters() throws Exception {
        ...
        Assert.assertTrue(settings.getContentFilteringEnabled());
        settings.setContentFilteringEnabled(false);
        mHelper.loadUrl(TestPagesHelper.FILTER_TESTPAGES_TESTCASES_ROOT + "element-hiding");
