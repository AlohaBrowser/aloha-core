...
MediaPlayerId::MediaPlayerId(GlobalRenderFrameHostId frame_routing_id,
                             int delegate_id, const media::mojom::MediaPlayerId& aloha_player_id)
    : frame_routing_id(frame_routing_id), delegate_id(delegate_id), aloha_player_id(aloha_player_id) {}
