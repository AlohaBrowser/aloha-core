...
class COMPONENT_EXPORT(NETWORK_SERVICE) NetworkContext
 ...
 private:
  ...
  URLRequestContextOwner MakeURLRequestContext(
      ...
      scoped_refptr<SessionCleanupCookieStore> // ALOHA - Cookies https://app.clickup.com/t/2dmr616
          session_cleanup_cookie_stores[aloha::kCookieManagersCount],
      OnURLRequestContextBuilderConfiguredCallback
          on_url_request_context_builder_configured);
  // ALOHA - Cookies https://app.clickup.com/t/2dmr616
  ...
  // ALOHA - Cookies https://app.clickup.com/t/2dmr616
  std::unique_ptr<CookieManager> cookie_managers_[aloha::kCookieManagersCount];
